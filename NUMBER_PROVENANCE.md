...
Every number quoted in `docs/FINDINGS.md` traces to a CSV generated by a script in
...
- **Aggregation population.** Every aggregate in `FINDINGS.md` is computed over
