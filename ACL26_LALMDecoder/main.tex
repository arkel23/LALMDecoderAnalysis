...
off-the-shelf model was already doing (Spearman $\rho = -0.46$, $p = 0.002$). On the ten cells
whose baseline exceeds 50 WER the projector wins seven, with a median gain of 35.9 WER and a
largest of 81.7; on the eighteen whose baseline is under 20 WER it wins two, and costs a median
of 5.8 WER.
...
baseline on 9 of 12 cells, with a median gain of 6.6 WER. On genuinely held-out varieties of the
same languages it wins \emph{none} of the 18, at a median cost of 6.0 WER. The
...
weakness ($\rho = -0.46$, $p = 0.002$): up to 81.7 WER where those models produce degenerate
output, and
